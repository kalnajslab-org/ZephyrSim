...
class MainWindowQt(QtWidgets.QMainWindow):
    ...
    def _build_ui(self) -> None:
        ...
        self.tc_input = QtWidgets.QComboBox()
        self.tc_input.setEditable(True)
        self.tc_input.setInsertPolicy(QtWidgets.QComboBox.InsertPolicy.NoInsert)
        self.tc_input.setMinimumWidth(180)
        self.tc_input.lineEdit().returnPressed.connect(self.on_tc)
        self.tc_input.setToolTip("TC text — semicolon appended automatically; mash TC or press Enter to send; Up/Down scrolls history")
